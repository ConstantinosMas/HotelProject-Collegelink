            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form method="post" action="/../public/actions/Register.php">
                        ...
                        <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a href="/public/assets/login.php" class="already">You already have an account? Login here.</a></form>
                </div>
            </div>
        </div>
    </div>
