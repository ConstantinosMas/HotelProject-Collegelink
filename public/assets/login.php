    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" action="/../public/actions/Login.php">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button></div><a href="/public/assets/register.php" class="already">Not registered? Register here</a>
            </form>
        </div>
    </div>
